...
| Senparc.AI.AgentKernel | 基于 Senparc.AI 标准，整合多种 LLM Agent 能力的扩展内核，便于快速集成与开发 Agent 应用，支持多种大模型后端以及插件扩展。| [![Senparc.AI.AgentKernel](https://img.shields.io/nuget/v/Senparc.AI.AgentKernel.svg)](https://www.nuget.org/packages/Senparc.AI.AgentKernel/) |
