...
namespace Senparc.AI.AgentKernel
{
  ...
  "Metadata": null
            ...
            */
            ...
            var isFunctionCall = functionResultContent != null && functionResultContent.CallId != null;//TODO: need to find out the role of function calling result
    ...
    public class SenparcAiResult<T> : SenparcAiResult, IAiResult
    {
        ...
        public IAsyncEnumerable<AgentResponseUpdate>? /*SKContext*/
            StreamResult
        { get; set; }
